...
import '../screens/miniplayer/mini_player.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          toolbarHeight: 0,
          elevation: 0,
          systemOverlayStyle: SystemUiOverlayStyle(statusBarColor: Themecolors.background ?? const Color.fromARGB(255, 9, 19, 33), statusBarIconBrightness: Themecolors.enumcolor ?? Brightness.light),
        ),
        backgroundColor: Themecolors.background ?? const Color.fromARGB(255, 9, 19, 33),
            ...
            SizedBox(
              ...
              child: BottomAppBar(
                ...
                child: GNav(
                    ...
                    textStyle: TextStyle(fontWeight: FontWeight.w900, color: Themecolors.font ?? Colors.white, fontSize: 20.sp, overflow: TextOverflow.ellipsis),
                    ...
                    padding: EdgeInsets.only(left: 10.sp, right: 10.sp, top: 15.sp, bottom: 15.sp),
                    tabMargin: EdgeInsets.only(bottom: 10.sp, left: 15.sp, right: 15.sp, top: 5.sp),
                    selectedIndex: index,
                    onTabChange: (index) {
