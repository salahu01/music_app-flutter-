...
A Music Player project created in flutter using provider. Boilerplate supports android and ios, clone the appropriate branches mentioned below:

* For clone : https://github.com/salahu01/music_app-flutter-.git (stable channel)
